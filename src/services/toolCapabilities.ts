...
const titles: Record<string, string> = {
  ...
  repository_status: 'Graph- und LSP-Status prüfen',
  repository_search: 'Codegraph und Referenzen durchsuchen',
  repository_read: 'Quellcodebeleg lesen',
  ...
  os_control_status: 'Bildschirmsteuerung prüfen',
