...
pub fn run() {
    ...
    let app = builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::run_archive::run_archive_read,
            commands::run_archive::run_archive_write,
            commands::run_archive::run_archive_list,
            ...
            commands::research::research_preview,
            commands::research::research_prepare,
            commands::research::research_read,
            commands::research::research_write,
            commands::research::research_read_artifact,
            commands::research::research_export_artifact,
            commands::research::research_verify,
            commands::research::research_open,
            commands::research::research_release,
