...
if (process.platform !== 'win32' || process.arch !== 'x64')
  throw new Error('Managed Claude runtime currently targets Windows x64.')
...
const version = execFileSync(cli, ['--version'], { encoding: 'utf8', windowsHide: true, timeout: 15000 }).trim()
...
await writeFile(
  ...
  JSON.stringify({ sdkVersion: '0.3.266', cliVersion: '2.1.266', nodeVersion: process.versions.node, hashes }, null, 2)
)
