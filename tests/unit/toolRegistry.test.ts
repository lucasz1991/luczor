...
const TOOL_CONTRACT = [
  ...
  { name: 'repository_status', category: 'project', mutating: false, requiresApproval: true },
  { name: 'repository_search', category: 'project', mutating: false, requiresApproval: true },
  { name: 'repository_read', category: 'project', mutating: false, requiresApproval: true },
